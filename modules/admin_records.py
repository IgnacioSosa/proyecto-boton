...
def render_records_import(role_id=None):
    ...
    # Nota: se elimina el st.divider() aquí para evitar duplicados
    # Método: render_records_management (nuevo a nivel de módulo; orquesta uploader + tabla)
    ...
    # Método: render_admin_edit_form (corregir try/except y mover a nivel de módulo)
